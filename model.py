...
df = pd.read_csv(r'C:\Users\freed\Downloads\yolopose\dataset_path\dataset_pathdataset.csv')
...
model.save_model(r"C:\Users\freed\Downloads\yolopose\trained_model.json")
